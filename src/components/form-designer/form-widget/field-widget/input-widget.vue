<template>
  <form-item-wrapper :designer="designer" :field="field" :rules="rules" :design-state="designState"
    ...
    <div v-if="field.options.remark" class="question-tip">{{i18nt('designer.setting.remark')}}: {{field.options.remark}}</div>
    <el-input ref="fieldEditor" v-model="fieldModel"
      ...
      <template slot="append" v-if="field.options.appendButton">
        <span>{{field.options.appendButton}}</span>
      </template>
    </el-input>
  </form-item-wrapper>
</template>
