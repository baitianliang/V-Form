  ...
  <div class="toolbar-container">
    <div class="left-toolbar">
      ...
      <el-button-group style="margin-left: 20px">
        ...
        <el-button v-if="false" :type="layoutType === 'Pad' ? 'info': ''" @click="changeLayoutType('Pad')">
      ...
      <el-button v-if="false" type="" style="margin-left: 20px" :title="i18nt('designer.toolbar.nodeTreeHint')" @click="showNodeTreeDrawer">
